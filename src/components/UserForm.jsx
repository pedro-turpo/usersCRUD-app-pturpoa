...
const UserForm = ({ isShowModal, changeShowModal, createUser }) => {
    ...
    return (
        <section className={`fixed top-0 left-0 right-0 h-screen bg-black/30 flex ${isShowModal ? 'visible opacity-100 transition duration-300 ease-in-out' : 'invisible opacity-0 transition'}`}>
            ...
            <form onSubmit={handleSubmit(submit)}
                ...
                {/* Title */}
                <h2 className="text-center text-[24px] font-bold pb-8 text-white">Create New User</h2>
                ...
                {/* Button to input */}
                <button className="mx-auto mt-12 w-[200px] p-[6px] bg rounded-md bg-primary text-sm text-white">Add new user</button>
